...
export const PDF_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'forms', name: 'PDF Forms', desc: 'Fill out interactive forms and checkboxes.', icon: FormInput, color: 'text-violet-600', bg: 'bg-violet-50', inactive: true, badge: 'Coming Soon' },
    ],
  },
  {
    title: 'PDF Security',
