...
export const PDF_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'word-to-pdf', name: 'WORD to PDF', desc: 'Convert DOCX files directly to PDF.', icon: FileText, color: 'text-blue-500', bg: 'bg-blue-50' },
      ...
      { id: 'html-to-pdf', name: 'HTML to PDF', desc: 'Render web pages and HTML strings to PDF.', icon: FileCode, color: 'text-amber-500', bg: 'bg-amber-50' },
    ],
  },
  {
